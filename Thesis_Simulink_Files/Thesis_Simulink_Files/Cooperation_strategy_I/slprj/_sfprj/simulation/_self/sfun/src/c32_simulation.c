...
static const char * c32_debug_family_names[26] = { "xh", "yh", "xjh", "yjh",
...
static void c32_e_emlrt_marshallIn(SFc32_simulationInstanceStruct *chartInstance,
  const mxArray *c32_state_est, const char_T *c32_identifier, real_T c32_y[3]);
...
static void c32_g_emlrt_marshallIn(SFc32_simulationInstanceStruct *chartInstance,
  const mxArray *c32_Sigma, const char_T *c32_identifier, real_T c32_y[9]);
...
static real_T c32_sqrt(SFc32_simulationInstanceStruct *chartInstance, real_T
  c32_x);
...
static uint8_T c32_n_emlrt_marshallIn(SFc32_simulationInstanceStruct
  *chartInstance, const mxArray *c32_u, const emlrtMsgIdentifier *c32_parentId);
static void c32_b_sqrt(SFc32_simulationInstanceStruct *chartInstance, real_T
  *c32_x);
  ...
  (SFc32_simulationInstanceStruct *chartInstance)
{
  ...
  real_T (*c32_state_est)[3];
  real_T (*c32_cov_i)[4];
  real_T (*c32_Sigma)[9];
  c32_cov_i = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 4);
  c32_state_i = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 3);
  c32_state_est = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 2);
  c32_Sigma = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
  c32_st = NULL;
  c32_st = NULL;
  c32_y = NULL;
  sf_mex_assign(&c32_y, sf_mex_createcellarray(5), FALSE);
  for (c32_i0 = 0; c32_i0 < 9; c32_i0++) {
    c32_u[c32_i0] = (*c32_Sigma)[c32_i0];
  }

  c32_b_y = NULL;
  sf_mex_assign(&c32_b_y, sf_mex_create("y", c32_u, 0, 0U, 1U, 0U, 2, 3, 3),
                FALSE);
  sf_mex_setcell(c32_y, 0, c32_b_y);
  for (c32_i1 = 0; c32_i1 < 4; c32_i1++) {
    c32_b_u[c32_i1] = (*c32_cov_i)[c32_i1];
  }
  ...
  for (c32_i2 = 0; c32_i2 < 3; c32_i2++) {
    c32_c_u[c32_i2] = (*c32_state_est)[c32_i2];
  }

  c32_d_y = NULL;
  sf_mex_assign(&c32_d_y, sf_mex_create("y", c32_c_u, 0, 0U, 1U, 0U, 1, 3),
                FALSE);
  sf_mex_setcell(c32_y, 2, c32_d_y);
  for (c32_i3 = 0; c32_i3 < 2; c32_i3++) {
    c32_d_u[c32_i3] = (*c32_state_i)[c32_i3];
  }
...
static void sf_c32_simulation(SFc32_simulationInstanceStruct *chartInstance)
{
  ...
  real_T (*c32_p_j)[2];
  real_T (*c32_state_est)[3];
  real_T (*c32_Sigma_predict)[9];
  real_T (*c32_state_predict)[3];
  real_T (*c32_Sigma)[9];
  c32_cov_i = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 4);
  c32_state_i = (real_T (*)[2])ssGetOutputPortSignal(chartInstance->S, 3);
  c32_j = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
  c32_p_j = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 3);
  c32_state_est = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 2);
  c32_z = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c32_Sigma_predict = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 1);
  c32_state_predict = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  c32_Sigma = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 31U, chartInstance->c32_sfEvent);
  for (c32_i8 = 0; c32_i8 < 9; c32_i8++) {
    _SFD_DATA_RANGE_CHECK((*c32_Sigma)[c32_i8], 0U);
  }

  for (c32_i9 = 0; c32_i9 < 3; c32_i9++) {
    _SFD_DATA_RANGE_CHECK((*c32_state_predict)[c32_i9], 1U);
  }

  for (c32_i10 = 0; c32_i10 < 9; c32_i10++) {
    _SFD_DATA_RANGE_CHECK((*c32_Sigma_predict)[c32_i10], 2U);
  }

  _SFD_DATA_RANGE_CHECK(*c32_z, 3U);
  for (c32_i11 = 0; c32_i11 < 3; c32_i11++) {
    _SFD_DATA_RANGE_CHECK((*c32_state_est)[c32_i11], 4U);
  }

  for (c32_i12 = 0; c32_i12 < 2; c32_i12++) {
    _SFD_DATA_RANGE_CHECK((*c32_p_j)[c32_i12], 5U);
  }

  _SFD_DATA_RANGE_CHECK(chartInstance->c32_nsonar, 6U);
  _SFD_DATA_RANGE_CHECK(*c32_j, 7U);
  _SFD_DATA_RANGE_CHECK(chartInstance->c32_i, 8U);
  for (c32_i13 = 0; c32_i13 < 2; c32_i13++) {
    _SFD_DATA_RANGE_CHECK((*c32_state_i)[c32_i13], 9U);
  }

  for (c32_i14 = 0; c32_i14 < 4; c32_i14++) {
    _SFD_DATA_RANGE_CHECK((*c32_cov_i)[c32_i14], 10U);
  }
  ...
  *chartInstance)
{
  ...
  real_T c32_j;
  real_T c32_b_i;
  uint32_T c32_debug_family_var_map[26];
  real_T c32_xh;
  real_T c32_yh;
  real_T c32_xjh;
  real_T c32_yjh;
  ...
  real_T *c32_b_z;
  real_T *c32_b_j;
  real_T (*c32_b_Sigma)[9];
  real_T (*c32_b_state_est)[3];
  real_T (*c32_b_state_i)[2];
  real_T (*c32_b_cov_i)[4];
  real_T (*c32_b_p_j)[2];
  real_T (*c32_b_Sigma_predict)[9];
  real_T (*c32_b_state_predict)[3];
  ...
  c32_b_j = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
  c32_b_p_j = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 3);
  c32_b_state_est = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 2);
  c32_b_z = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c32_b_Sigma_predict = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 1);
  c32_b_state_predict = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  c32_b_Sigma = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  for (c32_i15 = 0; c32_i15 < 3; c32_i15++) {
    c32_state_predict[c32_i15] = (*c32_b_state_predict)[c32_i15];
  }

  for (c32_i16 = 0; c32_i16 < 9; c32_i16++) {
    c32_Sigma_predict[c32_i16] = (*c32_b_Sigma_predict)[c32_i16];
  }

  c32_z = c32_hoistedGlobal;
  for (c32_i17 = 0; c32_i17 < 2; c32_i17++) {
    c32_p_j[c32_i17] = (*c32_b_p_j)[c32_i17];
  }

  c32_b_nsonar = c32_b_hoistedGlobal;
  c32_j = c32_c_hoistedGlobal;
  c32_b_i = c32_d_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 26U, 26U, c32_debug_family_names,
    c32_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c32_xh, 0U, c32_e_sf_marshallOut,
    c32_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c32_yh, 1U, c32_e_sf_marshallOut,
    c32_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c32_xjh, 2U, c32_e_sf_marshallOut,
    c32_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c32_yjh, 3U, c32_e_sf_marshallOut,
    c32_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c32_dxhat, 4U, c32_e_sf_marshallOut,
    c32_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c32_dyhat, 5U, c32_e_sf_marshallOut,
    c32_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c32_rhat, 6U, c32_e_sf_marshallOut,
    c32_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c32_H, 7U, c32_g_sf_marshallOut,
    c32_g_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c32_R, 8U, c32_e_sf_marshallOut,
    c32_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c32_S, 9U, c32_e_sf_marshallOut,
    c32_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c32_K, 10U, c32_c_sf_marshallOut,
    c32_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c32_lambda, 11U, c32_e_sf_marshallOut,
    c32_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c32_cov11, 12U, c32_f_sf_marshallOut,
    c32_f_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c32_nargin, 13U, c32_e_sf_marshallOut,
    c32_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c32_nargout, 14U, c32_e_sf_marshallOut,
    c32_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c32_state_predict, 15U, c32_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c32_Sigma_predict, 16U, c32_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c32_z, 17U, c32_e_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c32_p_j, 18U, c32_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c32_b_nsonar, 19U, c32_e_sf_marshallOut,
    c32_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c32_j, 20U, c32_e_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c32_b_i, 21U, c32_e_sf_marshallOut,
    c32_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c32_Sigma, 22U, c32_d_sf_marshallOut,
    c32_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c32_state_est, 23U, c32_c_sf_marshallOut,
    c32_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c32_state_i, 24U, c32_b_sf_marshallOut,
    c32_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c32_cov_i, 25U, c32_sf_marshallOut,
    c32_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c32_sfEvent, 5);
  for (c32_i18 = 0; c32_i18 < 3; c32_i18++) {
    c32_state_est[c32_i18] = c32_state_predict[c32_i18];
  }

  _SFD_EML_CALL(0U, chartInstance->c32_sfEvent, 7);
  for (c32_i19 = 0; c32_i19 < 9; c32_i19++) {
    c32_Sigma[c32_i19] = c32_Sigma_predict[c32_i19];
  }

  _SFD_EML_CALL(0U, chartInstance->c32_sfEvent, 10);
  guard1 = FALSE;
  if (CV_EML_COND(0, 1, 0, c32_b_i != c32_j)) {
    c32_b = c32_b_nsonar;
    c32_y = 20.0 * c32_b;
    if (CV_EML_COND(0, 1, 1, c32_z > c32_y)) {
      ...
      c32_dxhat = c32_xh - c32_xjh;
      _SFD_EML_CALL(0U, chartInstance->c32_sfEvent, 19);
      c32_dyhat = c32_yh - c32_yjh;
      _SFD_EML_CALL(0U, chartInstance->c32_sfEvent, 21);
      c32_rhat = c32_mpower(chartInstance, c32_dxhat) + c32_mpower(chartInstance,
        c32_dyhat);
      c32_b_sqrt(chartInstance, &c32_rhat);
      ...
      for (c32_i23 = 0; c32_i23 < 3; c32_i23++) {
        ...
        for (c32_i24 = 0; c32_i24 < 3; c32_i24++) {
          c32_h_y[c32_i23] += c32_a[c32_i24] * c32_d_b[c32_i24 + c32_i22];
        }
      ...
      for (c32_k = 1; c32_k < 4; c32_k++) {
        c32_b_k = c32_k;
        c32_i_y += c32_h_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
          _SFD_INTEGER_CHECK("", (real_T)c32_b_k), 1, 3, 1, 0) - 1] *
          c32_e_b[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
          (real_T)c32_b_k), 1, 3, 1, 0) - 1];
      }

      c32_S = c32_i_y + c32_R;
      _SFD_EML_CALL(0U, chartInstance->c32_sfEvent, 34);
      for (c32_i26 = 0; c32_i26 < 9; c32_i26++) {
        c32_d_b[c32_i26] = c32_Sigma_predict[c32_i26];
      }

      for (c32_i27 = 0; c32_i27 < 3; c32_i27++) {
        c32_e_b[c32_i27] = c32_H[c32_i27];
      }
      ...
      for (c32_i28 = 0; c32_i28 < 3; c32_i28++) {
        ...
        for (c32_i30 = 0; c32_i30 < 3; c32_i30++) {
          c32_j_y[c32_i28] += c32_d_b[c32_i29 + c32_i28] * c32_e_b[c32_i30];
          c32_i29 += 3;
        }
      }
      ...
      c32_k_y = c32_c_B;
      c32_l_y = c32_k_y;
      for (c32_i31 = 0; c32_i31 < 3; c32_i31++) {
        c32_K[c32_i31] = c32_j_y[c32_i31] / c32_l_y;
      }

      _SFD_EML_CALL(0U, chartInstance->c32_sfEvent, 36);
      c32_lambda = c32_z - c32_rhat;
      _SFD_EML_CALL(0U, chartInstance->c32_sfEvent, 39);
      for (c32_i32 = 0; c32_i32 < 3; c32_i32++) {
        c32_e_b[c32_i32] = c32_K[c32_i32];
      }

      c32_f_b = c32_lambda;
      for (c32_i33 = 0; c32_i33 < 3; c32_i33++) {
        c32_e_b[c32_i33] *= c32_f_b;
      }

      for (c32_i34 = 0; c32_i34 < 3; c32_i34++) {
        c32_state_est[c32_i34] = c32_state_predict[c32_i34] + c32_e_b[c32_i34];
      }

      _SFD_EML_CALL(0U, chartInstance->c32_sfEvent, 41);
      for (c32_i35 = 0; c32_i35 < 3; c32_i35++) {
        c32_e_b[c32_i35] = c32_K[c32_i35];
      }

      for (c32_i36 = 0; c32_i36 < 3; c32_i36++) {
        c32_a[c32_i36] = c32_H[c32_i36];
      }

      for (c32_i37 = 0; c32_i37 < 3; c32_i37++) {
        c32_i38 = 0;
        for (c32_i39 = 0; c32_i39 < 3; c32_i39++) {
          c32_m_y[c32_i38 + c32_i37] = c32_e_b[c32_i37] * c32_a[c32_i39];
          c32_i38 += 3;
        }
      }

      for (c32_i40 = 0; c32_i40 < 9; c32_i40++) {
        c32_d_b[c32_i40] = c32_Sigma_predict[c32_i40];
      }

      c32_e_eml_scalar_eg(chartInstance);
      c32_e_eml_scalar_eg(chartInstance);
      for (c32_i41 = 0; c32_i41 < 3; c32_i41++) {
        c32_i42 = 0;
        for (c32_i43 = 0; c32_i43 < 3; c32_i43++) {
          c32_n_y[c32_i42 + c32_i41] = 0.0;
          c32_i44 = 0;
          for (c32_i45 = 0; c32_i45 < 3; c32_i45++) {
            c32_n_y[c32_i42 + c32_i41] += c32_m_y[c32_i44 + c32_i41] *
              c32_d_b[c32_i45 + c32_i42];
            c32_i44 += 3;
          }
      ...
      for (c32_i46 = 0; c32_i46 < 9; c32_i46++) {
        c32_Sigma[c32_i46] = c32_Sigma_predict[c32_i46] - c32_n_y[c32_i46];
      }
    } else {
      guard1 = TRUE;
    }
  ...
  for (c32_i47 = 0; c32_i47 < 2; c32_i47++) {
    c32_state_i[c32_i47] = c32_state_est[c32_i47];
  }

  _SFD_EML_CALL(0U, chartInstance->c32_sfEvent, 45);
  c32_i48 = 0;
  c32_i49 = 0;
  for (c32_i50 = 0; c32_i50 < 2; c32_i50++) {
    for (c32_i51 = 0; c32_i51 < 2; c32_i51++) {
      c32_cov11[c32_i51 + c32_i48] = c32_Sigma[c32_i51 + c32_i49];
    }
  ...
  _SFD_EML_CALL(0U, chartInstance->c32_sfEvent, 46);
  for (c32_i52 = 0; c32_i52 < 4; c32_i52++) {
    c32_cov_i[c32_i52] = c32_cov11[c32_i52];
  }

  _SFD_EML_CALL(0U, chartInstance->c32_sfEvent, -46);
  _SFD_SYMBOL_SCOPE_POP();
  for (c32_i53 = 0; c32_i53 < 9; c32_i53++) {
    (*c32_b_Sigma)[c32_i53] = c32_Sigma[c32_i53];
  }

  for (c32_i54 = 0; c32_i54 < 3; c32_i54++) {
    (*c32_b_state_est)[c32_i54] = c32_state_est[c32_i54];
  }

  for (c32_i55 = 0; c32_i55 < 2; c32_i55++) {
    (*c32_b_state_i)[c32_i55] = c32_state_i[c32_i55];
  }

  for (c32_i56 = 0; c32_i56 < 4; c32_i56++) {
    (*c32_b_cov_i)[c32_i56] = c32_cov_i[c32_i56];
  }
  ...
  *c32_inData)
{
  ...
  for (c32_i57 = 0; c32_i57 < 4; c32_i57++) {
    c32_b_inData[c32_i57] = (*(real_T (*)[4])c32_inData)[c32_i57];
  }

  for (c32_i58 = 0; c32_i58 < 4; c32_i58++) {
    c32_u[c32_i58] = c32_b_inData[c32_i58];
  }
  ...
  const mxArray *c32_u, const emlrtMsgIdentifier *c32_parentId, real_T c32_y[4])
{
  real_T c32_dv4[4];
  int32_T c32_i59;
  sf_mex_import(c32_parentId, sf_mex_dup(c32_u), c32_dv4, 1, 0, 0U, 1, 0U, 1, 4);
  for (c32_i59 = 0; c32_i59 < 4; c32_i59++) {
    c32_y[c32_i59] = c32_dv4[c32_i59];
  }
  ...
  *c32_mxArrayInData, const char_T *c32_varName, void *c32_outData)
{
  ...
  c32_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c32_cov_i), &c32_thisId,
    c32_y);
  sf_mex_destroy(&c32_cov_i);
  for (c32_i60 = 0; c32_i60 < 4; c32_i60++) {
    (*(real_T (*)[4])c32_outData)[c32_i60] = c32_y[c32_i60];
  }
  ...
  *c32_inData)
{
  ...
  for (c32_i61 = 0; c32_i61 < 2; c32_i61++) {
    c32_b_inData[c32_i61] = (*(real_T (*)[2])c32_inData)[c32_i61];
  }

  for (c32_i62 = 0; c32_i62 < 2; c32_i62++) {
    c32_u[c32_i62] = c32_b_inData[c32_i62];
  }
  ...
  const mxArray *c32_u, const emlrtMsgIdentifier *c32_parentId, real_T c32_y[2])
{
  real_T c32_dv5[2];
  int32_T c32_i63;
  sf_mex_import(c32_parentId, sf_mex_dup(c32_u), c32_dv5, 1, 0, 0U, 1, 0U, 1, 2);
  for (c32_i63 = 0; c32_i63 < 2; c32_i63++) {
    c32_y[c32_i63] = c32_dv5[c32_i63];
  }
  ...
  *c32_mxArrayInData, const char_T *c32_varName, void *c32_outData)
{
  ...
  c32_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c32_state_i), &c32_thisId,
    c32_y);
  sf_mex_destroy(&c32_state_i);
  for (c32_i64 = 0; c32_i64 < 2; c32_i64++) {
    (*(real_T (*)[2])c32_outData)[c32_i64] = c32_y[c32_i64];
  }
  ...
  *c32_inData)
{
  ...
  chartInstance = (SFc32_simulationInstanceStruct *)chartInstanceVoid;
  c32_mxArrayOutData = NULL;
  for (c32_i65 = 0; c32_i65 < 3; c32_i65++) {
    c32_b_inData[c32_i65] = (*(real_T (*)[3])c32_inData)[c32_i65];
  }

  for (c32_i66 = 0; c32_i66 < 3; c32_i66++) {
    c32_u[c32_i66] = c32_b_inData[c32_i66];
  }
  ...
  const mxArray *c32_u, const emlrtMsgIdentifier *c32_parentId, real_T c32_y[3])
{
  ...
  for (c32_i67 = 0; c32_i67 < 3; c32_i67++) {
    c32_y[c32_i67] = c32_dv6[c32_i67];
  }
  ...
  *c32_mxArrayInData, const char_T *c32_varName, void *c32_outData)
{
  ...
  c32_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c32_state_est), &c32_thisId,
    c32_y);
  sf_mex_destroy(&c32_state_est);
  for (c32_i68 = 0; c32_i68 < 3; c32_i68++) {
    (*(real_T (*)[3])c32_outData)[c32_i68] = c32_y[c32_i68];
  }
  ...
  *c32_inData)
{
  ...
  c32_mxArrayOutData = NULL;
  c32_i69 = 0;
  for (c32_i70 = 0; c32_i70 < 3; c32_i70++) {
    for (c32_i71 = 0; c32_i71 < 3; c32_i71++) {
      c32_b_inData[c32_i71 + c32_i69] = (*(real_T (*)[9])c32_inData)[c32_i71 +
        c32_i69];
    }
  ...
  c32_i72 = 0;
  for (c32_i73 = 0; c32_i73 < 3; c32_i73++) {
    for (c32_i74 = 0; c32_i74 < 3; c32_i74++) {
      c32_u[c32_i74 + c32_i72] = c32_b_inData[c32_i74 + c32_i72];
    }
  ...
  const mxArray *c32_u, const emlrtMsgIdentifier *c32_parentId, real_T c32_y[9])
{
  ...
  sf_mex_import(c32_parentId, sf_mex_dup(c32_u), c32_dv7, 1, 0, 0U, 1, 0U, 2, 3,
                3);
  for (c32_i75 = 0; c32_i75 < 9; c32_i75++) {
    c32_y[c32_i75] = c32_dv7[c32_i75];
  }
  ...
  *c32_mxArrayInData, const char_T *c32_varName, void *c32_outData)
{
  ...
  sf_mex_destroy(&c32_Sigma);
  c32_i76 = 0;
  for (c32_i77 = 0; c32_i77 < 3; c32_i77++) {
    for (c32_i78 = 0; c32_i78 < 3; c32_i78++) {
      (*(real_T (*)[9])c32_outData)[c32_i78 + c32_i76] = c32_y[c32_i78 + c32_i76];
    }
  ...
  *c32_inData)
{
  ...
  c32_mxArrayOutData = NULL;
  c32_i79 = 0;
  for (c32_i80 = 0; c32_i80 < 2; c32_i80++) {
    for (c32_i81 = 0; c32_i81 < 2; c32_i81++) {
      c32_b_inData[c32_i81 + c32_i79] = (*(real_T (*)[4])c32_inData)[c32_i81 +
        c32_i79];
    }
  ...
  c32_i82 = 0;
  for (c32_i83 = 0; c32_i83 < 2; c32_i83++) {
    for (c32_i84 = 0; c32_i84 < 2; c32_i84++) {
      c32_u[c32_i84 + c32_i82] = c32_b_inData[c32_i84 + c32_i82];
    }
  ...
  const mxArray *c32_u, const emlrtMsgIdentifier *c32_parentId, real_T c32_y[4])
{
  real_T c32_dv8[4];
  int32_T c32_i85;
  sf_mex_import(c32_parentId, sf_mex_dup(c32_u), c32_dv8, 1, 0, 0U, 1, 0U, 2, 2,
                2);
  for (c32_i85 = 0; c32_i85 < 4; c32_i85++) {
    c32_y[c32_i85] = c32_dv8[c32_i85];
  }
  ...
  *c32_mxArrayInData, const char_T *c32_varName, void *c32_outData)
{
  ...
  for (c32_i87 = 0; c32_i87 < 2; c32_i87++) {
    for (c32_i88 = 0; c32_i88 < 2; c32_i88++) {
      (*(real_T (*)[4])c32_outData)[c32_i88 + c32_i86] = c32_y[c32_i88 + c32_i86];
    }
  ...
  *c32_inData)
{
  ...
  chartInstance = (SFc32_simulationInstanceStruct *)chartInstanceVoid;
  c32_mxArrayOutData = NULL;
  for (c32_i89 = 0; c32_i89 < 3; c32_i89++) {
    c32_b_inData[c32_i89] = (*(real_T (*)[3])c32_inData)[c32_i89];
  }

  for (c32_i90 = 0; c32_i90 < 3; c32_i90++) {
    c32_u[c32_i90] = c32_b_inData[c32_i90];
  }

  c32_y = NULL;
  sf_mex_assign(&c32_y, sf_mex_create("y", c32_u, 0, 0U, 1U, 0U, 2, 1, 3), FALSE);
  sf_mex_assign(&c32_mxArrayOutData, c32_y, FALSE);
  return c32_mxArrayOutData;
}
  ...
  const mxArray *c32_u, const emlrtMsgIdentifier *c32_parentId, real_T c32_y[3])
{
  real_T c32_dv9[3];
  int32_T c32_i91;
  sf_mex_import(c32_parentId, sf_mex_dup(c32_u), c32_dv9, 1, 0, 0U, 1, 0U, 2, 1,
                3);
  for (c32_i91 = 0; c32_i91 < 3; c32_i91++) {
    c32_y[c32_i91] = c32_dv9[c32_i91];
  }
  ...
  *c32_mxArrayInData, const char_T *c32_varName, void *c32_outData)
{
  ...
  c32_thisId.fIdentifier = c32_identifier;
  c32_thisId.fParent = NULL;
  c32_k_emlrt_marshallIn(chartInstance, sf_mex_dup(c32_H), &c32_thisId, c32_y);
  sf_mex_destroy(&c32_H);
  for (c32_i92 = 0; c32_i92 < 3; c32_i92++) {
    (*(real_T (*)[3])c32_outData)[c32_i92] = c32_y[c32_i92];
  }
...
static void c32_info_helper(const mxArray **c32_info)
{
  ...
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("mpower"), "name", "name", 2);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 2);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 5);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("power"), "name", "name", 5);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 5);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m!fltpower"), "context",
                  "context", 9);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("floor"), "name", "name", 9);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 9);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m!scalar_float_power"),
                  "context", "context", 13);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("mtimes"), "name", "name", 13);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 13);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m"), "resolved",
  ...
  sf_mex_addfield(*c32_info, sf_mex_duplicatearraysafe(&c32_lhs13), "lhs", "lhs",
                  13);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut(""), "context", "context", 14);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("sqrt"), "name", "name", 14);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 14);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m!below_threshold"),
                  "context", "context", 26);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("mtimes"), "name", "name", 26);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 26);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m"), "resolved",
  ...
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 46);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("intmax"), "name", "name", 46);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 46);
  sf_mex_addfield(*c32_info, c32_emlrt_marshallOut(
  ...
  c32_x)
{
  real_T c32_b_x;
  c32_b_x = c32_x;
  c32_b_sqrt(chartInstance, &c32_b_x);
  return c32_b_x;
}
...
static void c32_eml_error(SFc32_simulationInstanceStruct *chartInstance)
{
  ...
  const mxArray *c32_y = NULL;
  int32_T c32_i94;
  static char_T c32_cv1[4] = { 's', 'q', 'r', 't' };

  char_T c32_b_u[4];
  const mxArray *c32_b_y = NULL;
  for (c32_i93 = 0; c32_i93 < 30; c32_i93++) {
    c32_u[c32_i93] = c32_cv0[c32_i93];
  }

  c32_y = NULL;
  sf_mex_assign(&c32_y, sf_mex_create("y", c32_u, 10, 0U, 1U, 0U, 2, 1, 30),
                FALSE);
  for (c32_i94 = 0; c32_i94 < 4; c32_i94++) {
    c32_b_u[c32_i94] = c32_cv1[c32_i94];
  }
  ...
  *chartInstance, const mxArray *c32_u, const emlrtMsgIdentifier *c32_parentId)
{
  int32_T c32_y;
  int32_T c32_i95;
  sf_mex_import(c32_parentId, sf_mex_dup(c32_u), &c32_i95, 1, 6, 0U, 0, 0U, 0);
  c32_y = c32_i95;
  sf_mex_destroy(&c32_u);
  return c32_y;
}
  ...
  *c32_x)
{
  ...
  *c32_x = muDoubleScalarSqrt(*c32_x);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2684697844U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1146752586U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1534367913U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3340839153U);
}
...
mxArray *sf_c32_simulation_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("CPhSk0XVJEHPVmQsM8kWhB");
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c32_j = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
          c32_p_j = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 3);
          c32_state_est = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S,
            2);
          c32_z = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
          c32_Sigma_predict = (real_T (*)[9])ssGetInputPortSignal
            (chartInstance->S, 1);
          c32_state_predict = (real_T (*)[3])ssGetInputPortSignal
            (chartInstance->S, 0);
          c32_Sigma = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
          ...
          _SFD_SET_DATA_VALUE_PTR(5U, *c32_p_j);
          _SFD_SET_DATA_VALUE_PTR(6U, &chartInstance->c32_nsonar);
          _SFD_SET_DATA_VALUE_PTR(7U, c32_j);
          _SFD_SET_DATA_VALUE_PTR(8U, &chartInstance->c32_i);
          _SFD_SET_DATA_VALUE_PTR(9U, *c32_state_i);
          _SFD_SET_DATA_VALUE_PTR(10U, *c32_cov_i);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c32_simulation(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1906424138U));
  ssSetChecksum1(S,(916214059U));
  ssSetChecksum2(S,(1747416164U));
  ssSetChecksum3(S,(3058773042U));
