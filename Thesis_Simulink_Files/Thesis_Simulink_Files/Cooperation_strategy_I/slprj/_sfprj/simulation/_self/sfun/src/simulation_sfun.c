  ...
  int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1512788283U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3326655460U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3440583778U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3227156075U);
  }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 15:
      {
        if (strcmp(aiChksum, "f7fEBjx1hm4T27GFY3SgEC") == 0) {
     ...
     case 32:
      {
        if (strcmp(aiChksum, "CPhSk0XVJEHPVmQsM8kWhB") == 0) {
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 15:
      {
        if (strcmp(tpChksum, "7IE2N7zi0E7CLDQi9K3JIH") == 0) {
     ...
     case 32:
      {
        if (strcmp(tpChksum, "Z1TiNDoCAwBSvIdfBL40sE") == 0) {
